    ...
    examples: [
      {
        ...
        messages: [
          ...
          {
            from: 'empath',
            text: 'Das musst du heute Nacht nicht klären. Dass du es immer wieder durchspielst, heißt meistens, dass es dir wichtig war — nicht, dass du überreagiert hast. Soll ich es dir bis morgen früh aufheben?',
            time: '02:47',
          },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: 'Wenn du zurückblicken, eine Erinnerung hervorholen oder deine Stimmungsmuster und Trends sehen willst — in der App wartet alles auf dich.',
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Ja! Empath ist komplett kostenlos. Das gesamte Kern-Journaling per SMS, Anruf oder App — plus KI-Transkription, Stimmungstracking und Erkenntnisse — ist gratis enthalten.',
      },
      {
